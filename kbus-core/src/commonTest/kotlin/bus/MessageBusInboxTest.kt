    ...
    fun aRedeliveredEnvelopeIsDedupedOnItsId_soHandlersRunOnce() = runTest {
        ...
        val bus =
            MessageBus(
                ...
                contexts = listOf(BoundedContext(BoundedContextId("healthy"), healthyLocator)),
                inbox =
                    InboxConfig(
                        ackPolicy = InboxAckPolicy.HonourEventStrategy,
    ...
    fun aFailingIntegrationHandlerNeverFailsTheCommand() = runTest {
        ...
        val bus =
            MessageBus(
                ...
                contexts = listOf(BoundedContext(BoundedContextId("failing"), failingLocator)),
                inbox =
                    InboxConfig(
                        ackPolicy = InboxAckPolicy.HonourEventStrategy,
    ...
    fun aDefaultSettingsEventIsNotAckedUntilItsHandlerCompletes() = runTest {
        ...
        val bus =
            MessageBus(
                ...
                contexts = listOf(BoundedContext(BoundedContextId("healthy"), locator)),
                inbox =
                    InboxConfig(
                        ackPolicy = InboxAckPolicy.HonourEventStrategy,
