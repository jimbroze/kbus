...
class MessageBusGenerator(
    ...
    //
    //    fun generate(packagePath: String, loaderName: String, handlers:
    // Set<LoadedHandlerDefinition>) {
    ...
    //        //                transactionManager: TransactionManager,
    //        //                loader: IContainer,
    //        //            ) : this(middleware, transactionManager,
    // GeneratedHandlerLocator(loader))
    //
    //        val busClassCode = StringBuilder()
    //        busClassCode.appendLine("class $busClassName")
    //        busClassCode.appendLine("private constructor(")
    //        busClassCode.appendLine("private val locator:
    // GeneratedHandlerLocator,".prependIndent())
    //        busClassCode.appendLine("transactionManager:
    // $transactionManagerClassName,".prependIndent())
    ...
    //            "transactionManager:
    // $transactionManagerClassName,".prependIndent().prependIndent()
    //        )
    //        busClassCode.appendLine(
    ...
    // handler.handlerDefinition.message.toClassName())
